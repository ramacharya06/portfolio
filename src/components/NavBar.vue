...
<template>
  <div class="w-full flex justify-center p-4 bg-linear-to-t from-[rgba(255,255,255,0)] to-zinc-200 dark:from-[rgba(0,0,0,0)] dark:to-zinc-800">
    <MenuBar :model="items" class="w-7/10 min-w-[300px] rounded-[10px] border-black dark:border-gray-600">
      <template #start>
        <router-link to="/">
          <Avatar :image="logo" shape="square" size="large" class="rounded-bg overflow-hidden" />
        </router-link>
      </template>
